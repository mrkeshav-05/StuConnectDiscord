...
import { selectServers } from '@/features/server/ServerSlice';
...
const ServerHeader: React.FC<ServerHeaderProps> = ({ role }) => {
    ...
    const [server, setServer] = useState<{ name: string } | undefined>();
    ...
    return (
        <div>
            <DropdownMenu>
                ...
                <DropdownMenuContent className='w-56 text-xs font-medium text-black dark:text-neutral-200 space-y-[2px]'>
                    {isModerator && (
